...
<div id="sidemenu" class="menu-collapsed">
    ...
    <div id="profile">
        ...
        <div id="name"><span>Ready Car Park</span></div>
    </div>
    ...
    <div id="menu-items">
        <div class="item">
            <a href="Supervisores.php">
                <div class="icon"><img src="../../img/Supervisor.png" alt=""></div>
                <div class="title"><span>SUPERVISORES</span></div>
            </a>
            <a href="Operarios.php">
                <div class="icon"><img src="../../img/Operario.png" alt=""></div>
                <div class="title"><span>OPERARIOS</span></div>
            </a>
            <a href="Tarifas.php">
                <div class="icon"><img src="../../img/tarifas.png" alt=""></div>
                <div class="title"><span>TARIFAS</span></div>
            </a>
            <a href="Pagos.php">
